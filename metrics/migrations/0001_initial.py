# Generated by Django 3.0.2 on 2021-10-15 18:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_format', models.CharField(max_length=10, null=True, verbose_name='DateFormat')),
            ],
        ),
        migrations.CreateModel(
            name='CustomWeight',
        ...
        migrations.AddField(
            ...
            name='custom',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metrics.Custom'),
        ),
        migrations.AddField(
            model_name='customweight',
            name='metric',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metrics.Metric'),
        ),
        migrations.AddField(
            model_name='custom',
            name='columns',
            field=models.ManyToManyField(related_name='custom_columns', to='metrics.Metric'),
        ),
        migrations.AddField(
            model_name='custom',
            name='weights',
            field=models.ManyToManyField(related_name='custom_weight', through='metrics.CustomWeight', to='metrics.Metric'),
        ),
        migrations.AddField(
            model_name='channel',
            name='sensor',
